...
#let (
  ...
  definition: ("Definition", lq.color.map.petroff6.at(0).lighten(60%).desaturate(40%)),
  theorem: ("Theorem", lq.color.map.petroff6.at(1).lighten(60%).desaturate(40%)),
  proposition: ("Proposition", lq.color.map.petroff6.at(1).lighten(60%).desaturate(40%)),
  corollary: ("Corollary", lq.color.map.petroff6.at(1).lighten(60%).desaturate(40%)),
  proof: ("Proof", lq.color.map.petroff6.at(5).lighten(65%).desaturate(45%)),
)
